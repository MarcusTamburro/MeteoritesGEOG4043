...
function createCredits(){
    var credits = L.Control.extend({
        ...
        onAdd: function () {
            ...
            //'<a id="' + "8" + '-text" x="2" y = "' + 80 + '" href=”https://github.com/freeCodeCamp/ProjectReferenceData/blob/master/meteorite-strike-data.json”><text id="' + "7" + '-text" x="2" y="' + 80 + '">' + "Github Link" + '</text></a>'
            svg2 += '<a xlink:href=https://github.com/freeCodeCamp/ProjectReferenceData/blob/master/meteorite-strike-data.json><text id="' + "7" + '-text" x="2" y="' + 80 + '" fill="blue">' + "Github Link" + '</text></a>'
            //'<text id="' + "7" + '-text" x="2" y="' + 80 + '">' + "https://github.com/freeCodeCamp/ProjectReferenceData/blob/master/meteorite-strike-data.json" + '</text>'
